package com.tccec.emotionpimobile.custom.circularbutton;
...
public class CircularProgressButton extends Button {
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.button_cpb_background).mutate();
    ...
    private void drawIndeterminateProgress(Canvas canvas) {
        if (mAnimatedDrawable == null) {
            ...
            /*int left = offset + mPaddingProgress;
            int right = getWidth()  - offset - mPaddingProgress;
            int bottom = (getHeight() * 2) - mPaddingProgress;
            int top = mPaddingProgress * 2;*/
    ...
    private void morphCompleteToProgress() {
        mIndeterminateProgressMode = true;
        ...
        animation.setToStrokeColor(mColorIndicator);
